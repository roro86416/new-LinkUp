			...
			},
			{
				product: {
					create: {
						...
						description:
							'加厚帆布材質，耐重且實用，內附小暗袋可收納鑰匙與手機。印有活動專屬 Logo，大容量設計讓您輕鬆裝下筆電與隨身物品，是日常通勤或逛展購物的環保好選擇。',
						base_price: 450,
						image_url:
			...
			},
			{
				product: {
					create: {
						...
						description:
							'陶瓷高溫燒製，手感溫潤，杯身印有本次活動的獨家插畫。適合在辦公室或居家使用，讓您在喝咖啡的同時，也能回憶起活動的美好時刻。附贈精美紙盒包裝，送禮自用兩相宜。',
						base_price: 350,
						image_url:
			...
			},
			{
				product: {
					create: {
						name: '活動限定防水貼紙組 (5入)',
						description:
							'精選 5 款不同設計的防水貼紙，採用高品質 PVC 材質，抗曬不褪色。可以貼在筆記型電腦、行李箱、水壺或安全帽上，展現您的獨特個性與對本次活動的熱愛。',
						base_price: 150,
						image_url:
			...
			},
			{
				product: {
					create: {
						...
						description:
							'經典老帽版型，適合各種臉型修飾。正面採用精緻立體刺繡工藝，呈現活動主題字樣，背面調節扣可自由調整頭圍。選用透氣布料，四季皆宜，是您穿搭的必備單品。',
						base_price: 580,
						image_url:
			...
			},
			{
				product: {
					create: {
						...
						description:
							'採用高品質鋅合金製作，表面琺瑯上色，色彩飽和且質感厚實。背後附有蝴蝶扣，可牢固別在包包或衣服上。極具收藏價值，是資深粉絲不可錯過的限定小物。',
						base_price: 200,
						image_url:
							'https://images.unsplash.com/photo-1541797873665-6d4cc148885f?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGJhZGdlfGVufDB8fDB8fHwy',
						is_published: true,
						variants: {
...
const generateEventImages = (category: string, seed: number) => {
	...
	switch (category) {
		case '課程':
			keywords = 'workshop,class,coding,teacher';
			break;
		case '展覽':
			keywords = 'exhibition,art,gallery,museum';
			break;
		case '派對':
			keywords = 'party,concert,music,club';
			break;
		case '聚會':
			keywords = 'meeting,friends,coffee,talk';
			break;
		case '市集':
			keywords = 'market,craft,food,stall';
			break;
		case '比賽':
			keywords = 'competition,sport,game,contest';
			break;
		case '表演':
			keywords = 'stage,performance,theater,band';
			break;
		case '研討會':
			keywords = 'conference,seminar,business,speaker';
			break;
		case '分享會':
			keywords = 'speech,sharing,story,audience';
			break;
		case '見面會':
			keywords = 'fan,meetup,idol,signature';
			break;
		case '宣傳活動':
			keywords = 'press,launch,media,camera';
			break;
		case '導覽':
			keywords = 'tour,guide,city,history';
			break;
		case '體驗':
			keywords = 'diy,crafting,making,hands-on';
			break;
	}
		...
		create: [
			{
				image: {
					create: {
						image_url: `https://source.unsplash.com/800x600/?${keywords}&sig=${seed}`,
					},
				},
			},
			{
				image: {
					create: {
						image_url: `https://source.unsplash.com/800x600/?${keywords}&sig=${seed + 100}`,
					},
				},
			},
			{
				image: {
					create: {
						image_url: `https://source.unsplash.com/800x600/?${keywords}&sig=${seed + 200}`,
					},
				},
			},
		],
...
export const mockEventsData = [
			...
			create: [
				{
					...
					price: 3500,
					total_quantity: 50,
					sale_start_time: new Date('2026-10-01'),
					sale_end_time: new Date('2026-11-30'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'福爾摩沙咖啡研究室',
			'手沖咖啡大師班',
			'從生豆挑選、烘焙曲線到萃取理論的完整解析，讓你在家也能煮出冠軍級的好咖啡',
		),
		cover_image:
			'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('課程', 102),
		start_time: new Date('2026-12-15T14:00:00Z'),
		end_time: new Date('2026-12-15T17:00:00Z'),
		location_name: '台南美術館二館 - 咖啡講堂',
		address: '台南市中西區忠義路二段1號',
		latitude: new Prisma.Decimal(22.99),
			...
			create: [
				{
					...
					price: 1200,
					total_quantity: 20,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2026-12-14'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'視覺光影工作室',
			'商業攝影工作坊',
			'專業棚燈運用與商品修圖實戰技巧，教你如何拍出有質感且具備商業吸引力的商品照片',
		),
		cover_image:
			'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('課程', 103),
		start_time: new Date('2027-01-10T10:00:00Z'),
		end_time: new Date('2027-01-10T17:00:00Z'),
		location_name: '駁二共創基地',
		address: '高雄市鹽埕區大勇路11號',
		latitude: new Prisma.Decimal(22.62),
			...
			create: [
				{
					...
					price: 2500,
					total_quantity: 30,
					sale_start_time: new Date('2026-12-01'),
					sale_end_time: new Date('2027-01-09'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'京都流花道台灣分會',
			'日式花藝課程',
			'草月流基礎技法與現代居家花藝應用，透過花草的姿態，為生活空間注入寧靜與美感',
		),
		cover_image:
			'https://images.unsplash.com/photo-1587334274328-64186a80aeee?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('課程', 104),
		start_time: new Date('2026-12-20T13:00:00Z'),
		end_time: new Date('2026-12-20T16:00:00Z'),
		location_name: '審計新村',
			...
			create: [
				{
					...
					price: 1800,
					total_quantity: 15,
					sale_start_time: new Date('2026-11-15'),
					sale_end_time: new Date('2026-12-19'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'未來視覺實驗室',
			'AI 藝術創作課',
			'從 Prompt 詠唱到 ControlNet 精準控制的完整流程，讓 AI 成為你最強大的創作助手',
		),
		cover_image:
			'https://images.unsplash.com/photo-1574030238814-db57c0ed8f80?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
		images: generateEventImages('課程', 105),
		start_time: new Date('2026-12-08T19:00:00Z'),
		end_time: new Date('2026-12-08T21:30:00Z'),
			...
			create: [
				{
					...
					total_quantity: 200,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2026-12-07'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'宜蘭極酷衝浪俱樂部',
			'新手衝浪營',
			'專業教練一對一指導，保證站板成功的安心課程，享受被海浪推著走的快感',
		),
		cover_image:
			'https://images.unsplash.com/photo-1502680390469-be75c86b636f?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('課程', 106),
		start_time: new Date('2027-03-15T09:00:00Z'),
		end_time: new Date('2027-03-15T16:00:00Z'),
		location_name: '烏石港衝浪街',
		address: '宜蘭縣頭城鎮港口路',
		latitude: new Prisma.Decimal(24.87),
		longitude: new Prisma.Decimal(121.84),
		status: EventStatus.APPROVED,
		event_type: EventType.OFFLINE,
		ticketTypes: {
			create: [
				{
					...
					price: 2200,
					total_quantity: 40,
					sale_start_time: new Date('2027-01-01'),
					sale_end_time: new Date('2027-03-14'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'台灣科技部創新司',
			'未來科技展',
			'5G、量子電腦與智慧城市的最新應用展示，親身體驗改變世界的黑科技',
		),
		cover_image:
			'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('展覽', 201),
		start_time: new Date('2027-01-05T09:00:00Z'),
		end_time: new Date('2027-01-08T17:00:00Z'),
			...
			create: [
				{
					...
					total_quantity: 5000,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2027-01-05'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'國際藝術策展中心',
			'莫內光影展',
			'結合 360 度巨型投影，重現吉維尼花園的夢幻場景，讓您彷彿置身於19世紀的法國',
		),
		cover_image:
			'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('展覽', 202),
		start_time: new Date('2026-12-10T10:00:00Z'),
		end_time: new Date('2027-03-10T18:00:00Z'),
			...
			create: [
				{
					...
					total_quantity: 3000,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2027-03-10'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'交通部台灣鐵路管理局',
			'鐵道百年展',
			'展出珍貴的蒸汽火車頭與歷代車票、制服演變，帶您回顧台灣鐵道發展的輝煌歷史',
		),
		cover_image:
		...
		start_time: new Date('2026-12-01T09:00:00Z'),
		end_time: new Date('2027-02-28T17:00:00Z'),
			...
			create: [
				{
					...
					total_quantity: 2000,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2027-02-28'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'亞洲插畫協會',
			'當代插畫藝術節',
			'匯集台日韓百位新銳插畫家，展現多元風格的創作能量，是插畫迷絕對不能錯過的年度盛會',
		),
		cover_image:
			...
			create: [
				{
					...
					price: 250,
					total_quantity: 1500,
					sale_start_time: new Date('2026-10-20'),
					sale_end_time: new Date('2026-11-30'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'國立海洋生物博物館',
			'深海生物展',
			'透過高科技互動裝置，帶您潛入萬米深海，一窺奇幻的生物螢光現象，認識神秘的深海生態',
		),
		cover_image:
			'https://images.unsplash.com/photo-1550998095-2c11477f02a0?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
		images: generateEventImages('展覽', 205),
		start_time: new Date('2027-01-20T09:00:00Z'),
		end_time: new Date('2027-04-20T17:00:00Z'),
		location_name: 'Xpark 都會水生公園',
		address: '桃園市中壢區春德路105號',
		latitude: new Prisma.Decimal(25.017),
		longitude: new Prisma.Decimal(121.22),
		status: EventStatus.APPROVED,
		event_type: EventType.OFFLINE,
		ticketTypes: {
			create: [
				{
					...
					total_quantity: 2000,
					sale_start_time: new Date('2026-12-01'),
					sale_end_time: new Date('2027-04-20'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'築生文化協會',
			'安藤忠雄建築展',
			'展出大師歷年經典作品手稿與模型，解析光與影的空間哲學，感受清水模建築的獨特魅力',
		),
		cover_image:
		...
		start_time: new Date('2026-12-15T10:00:00Z'),
		end_time: new Date('2027-02-15T18:00:00Z'),
		location_name: '富邦美術館',
		address: '台北市信義區松高路',
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'ShowHouse 娛樂集團',
			'跨年電音派對',
			'百大 DJ 輪番上陣，搭配千萬級雷射燈光秀，High 翻整晚不睡覺，用最強的節奏迎接新的一年',
		),
		cover_image:
			'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('派對', 301),
		start_time: new Date('2026-12-31T21:00:00Z'),
		end_time: new Date('2027-01-01T04:00:00Z'),
		location_name: '大佳河濱公園',
		address: '台北市中山區',
		latitude: new Prisma.Decimal(25.076),
		longitude: new Prisma.Decimal(121.55),
		status: EventStatus.APPROVED,
		event_type: EventType.OFFLINE,
		ticketTypes: {
			create: [
				{
					...
					total_quantity: 1000,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2026-12-30'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'Skyline 爵士俱樂部',
			'屋頂爵士派對',
			'在城市天際線的包圍下，享受現場爵士樂團的即興演奏與精緻調酒，是下班後放鬆的最佳選擇',
		),
		cover_image:
			'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('派對', 302),
		start_time: new Date('2026-11-29T20:00:00Z'),
		end_time: new Date('2026-11-29T23:30:00Z'),
			...
			create: [
				{
					...
					price: 1200,
					total_quantity: 100,
					sale_start_time: new Date('2026-10-29'),
					sale_end_time: new Date('2026-11-28'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'韓流舞蹈推廣社',
			'隨機舞蹈派對',
			'播放時下最夯的 K-POP 舞曲，歡迎所有熱愛舞蹈的朋友一起加入圓圈，展現你的舞蹈實力',
		),
		cover_image:
		...
		start_time: new Date('2026-12-06T16:00:00Z'),
		end_time: new Date('2026-12-06T20:00:00Z'),
			...
			create: [
				{
					...
					price: 100,
					total_quantity: 300,
					sale_start_time: new Date('2026-11-06'),
					sale_end_time: new Date('2026-12-05'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'復古時光機',
			'滑輪迪斯可',
			'穿上四輪溜冰鞋，在閃亮的迪斯可球下，隨著 80 年代金曲滑行起舞，重回那個美好的黃金年代',
		),
		cover_image:
			'https://images.unsplash.com/photo-1545128485-c400e7702796?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('派對', 304),
		start_time: new Date('2026-12-13T19:00:00Z'),
		end_time: new Date('2026-12-13T22:00:00Z'),
			...
			create: [
				{
					...
					price: 450,
					total_quantity: 80,
					sale_start_time: new Date('2026-11-13'),
					sale_end_time: new Date('2026-12-12'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'耳朵蟲音樂祭',
			'靜音派對',
			'全場無擴音設備，戴上專屬無線耳機，切換三個頻道的 DJ 音樂，在安靜的環境中享受獨特的狂歡體驗',
		),
		cover_image:
			'https://images.unsplash.com/photo-1667355745772-8c6b7990d044?q=80&w=1744&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
		images: generateEventImages('派對', 305),
		start_time: new Date('2026-12-20T21:00:00Z'),
		end_time: new Date('2026-12-21T01:00:00Z'),
			...
			create: [
				{
					...
					price: 600,
					total_quantity: 200,
					sale_start_time: new Date('2026-11-20'),
					sale_end_time: new Date('2026-12-19'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'皇家活動策劃',
			'聖誕化妝舞會',
			'著正式服裝與精緻面具出席，在奢華的宴會廳中尋找你的舞伴，度過一個充滿神秘與浪漫的聖誕夜',
		),
		cover_image:
			'https://images.unsplash.com/photo-1609263857016-03e9eafaa579?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z29sZGVuJTIwbWFza3xlbnwwfHwwfHx8MA%3D%3D',
		images: generateEventImages('派對', 306),
		start_time: new Date('2026-12-24T19:00:00Z'),
		end_time: new Date('2026-12-25T00:00:00Z'),
			...
			create: [
				{
					...
					total_quantity: 150,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2026-12-23'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'GDG Taipei',
			'開發者聚會',
			'針對移動端開發的最新技術趨勢進行分享，包含 Flutter, SwiftUI 與 Jetpack Compose，歡迎開發者一同交流',
		),
		cover_image:
			'https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('聚會', 401),
		start_time: new Date('2026-11-26T19:00:00Z'),
		end_time: new Date('2026-11-26T21:30:00Z'),
			...
			create: [
				{
					...
					total_quantity: 80,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2026-11-25'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'快樂桌遊推廣會',
			'桌遊聚會',
			'精選數十款熱門派對與策略桌遊，現場有教學人員帶領，新手也能輕鬆上手，是認識新朋友的好機會',
		),
		cover_image:
		...
		start_time: new Date('2026-12-05T19:00:00Z'),
		end_time: new Date('2026-12-05T23:00:00Z'),
		location_name: '女巫店',
			...
			create: [
				{
					...
					price: 300,
					total_quantity: 40,
					sale_start_time: new Date('2026-11-05'),
					sale_end_time: new Date('2026-12-04'),
				},
			],
		},
	...
	},
	{
		...
		subtitle: '用語言交朋友',
		description: generateDescription(
			'Global Friends Taiwan',
			'語言交換',
			'提供英語、日語、韓語、西語等換桌交流時間，結識來自世界各地的朋友，練習外語的同時拓展國際視野',
		),
		cover_image:
			'https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('聚會', 403),
		start_time: new Date('2026-12-12T19:30:00Z'),
		end_time: new Date('2026-12-12T22:00:00Z'),
			...
			create: [
				{
					...
					price: 250,
					total_quantity: 100,
					sale_start_time: new Date('2026-11-12'),
					sale_end_time: new Date('2026-12-11'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'區塊鏈共識實驗室',
			'加密貨幣聚會',
			'在輕鬆的早餐氛圍中，交流區塊鏈技術應用與加密貨幣市場分析，分享投資心得與未來展望',
		),
		cover_image:
			'https://images.unsplash.com/photo-1620808244394-f4b654ff7d8b?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Yml0JTIwY29pbnxlbnwwfHwwfHx8MA%3D%3D',
		images: generateEventImages('聚會', 404),
		start_time: new Date('2026-12-20T09:00:00Z'),
		end_time: new Date('2026-12-20T11:00:00Z'),
		location_name: 'Louisa Coffee 品牌旗艦店',
		address: '台北市大安區信義路二段',
		latitude: new Prisma.Decimal(25.034),
		longitude: new Prisma.Decimal(121.53),
		status: EventStatus.APPROVED,
		event_type: EventType.OFFLINE,
		ticketTypes: {
			create: [
	...
	},
	{
		...
		description: generateDescription(
			'汪星人俱樂部',
			'寵物野餐',
			'帶著家裡的狗狗貓貓一起到公園草地奔跑，主人們也能交流飼養心得，共度愉快的午後時光',
		),
		cover_image:
			'https://images.unsplash.com/photo-1548199973-03cce0bbc87b?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('聚會', 405),
		start_time: new Date('2026-11-30T14:00:00Z'),
		end_time: new Date('2026-11-30T17:00:00Z'),
			...
			create: [
				{
					...
					price: 0,
					total_quantity: 200,
					sale_start_time: new Date('2026-10-30'),
					sale_end_time: new Date('2026-11-29'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'巷弄讀書會',
			'週末讀書會',
			'深入導讀暢銷書籍，透過分組討論分享閱讀心得，將知識轉化為行動，一起培養閱讀的好習慣',
		),
		cover_image:
			'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('聚會', 406),
		start_time: new Date('2026-12-14T14:30:00Z'),
		end_time: new Date('2026-12-14T16:30:00Z'),
		location_name: '青鳥書店',
		address: '台北市中正區八德路一段1號',
		latitude: new Prisma.Decimal(25.044),
		longitude: new Prisma.Decimal(121.529),
			...
			create: [
				{
					...
					price: 150,
					total_quantity: 20,
					sale_start_time: new Date('2026-11-14'),
					sale_end_time: new Date('2026-12-13'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'好朋友市集策展團隊',
			'手作市集',
			'集結 50 攤原創手作職人，販售布藝、飾品、陶藝與插畫周邊，感受手作的獨特魅力與溫暖',
		),
		cover_image:
		...
		start_time: new Date('2026-12-06T11:00:00Z'),
		end_time: new Date('2026-12-07T18:00:00Z'),
		location_name: '四四南村',
	...
	},
	{
		...
		description: generateDescription(
			'台南觀光推廣局',
			'美食市集',
			'網羅台南在地隱藏版美食與人氣餐車，讓你一站式吃遍牛肉湯、碗粿與特色甜點，滿足你的味蕾',
		),
		cover_image:
			'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('市集', 502),
		start_time: new Date('2026-12-13T12:00:00Z'),
		end_time: new Date('2026-12-14T20:00:00Z'),
	...
	},
	{
		...
		description: generateDescription(
			'Old School 俱樂部',
			'古著市集',
			'匯集全台精選古著賣家，從美式工裝到日系昭和洋裝，挖寶尋找屬於你的時代風格，展現獨特個性',
		),
		cover_image:
			'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('市集', 503),
		start_time: new Date('2026-11-29T13:00:00Z'),
		end_time: new Date('2026-11-30T19:00:00Z'),
	...
	},
	{
		...
		description: generateDescription(
			'台灣友善耕作聯盟',
			'小農市集',
			'支持在地友善耕作農夫，販售當季新鮮有機蔬果、手作果醬與在地農產加工品，吃得健康又安心',
		),
		cover_image:
		...
		start_time: new Date('2026-12-20T08:00:00Z'),
		end_time: new Date('2026-12-20T14:00:00Z'),
		location_name: '希望廣場',
		address: '台北市中正區林森北路',
			...
			create: [
				{
					...
					total_quantity: 3000,
					sale_start_time: new Date('2026-11-20'),
					sale_end_time: new Date('2026-12-20'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'歐洲經貿辦事處',
			'聖誕市集',
			'彷彿置身歐洲廣場，熱紅酒、薑餅人、烤香腸與璀璨的聖誕燈飾，感受濃濃的節慶氛圍，是聖誕節約會首選',
		),
		cover_image:
		...
		start_time: new Date('2026-12-19T17:00:00Z'),
		end_time: new Date('2026-12-25T22:00:00Z'),
			...
			create: [
				{
					...
					sale_start_time: new Date('2026-11-19'),
					sale_end_time: new Date('2026-12-25'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'感傷唱片行',
			'音樂市集',
			'專屬於類比音樂愛好者的盛會，交流經典黑膠唱片、卡帶與復古播放器材，找回被數位時代遺忘的聲音溫度',
		),
		cover_image:
			'https://images.unsplash.com/photo-1484704849700-f032a568e944?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('市集', 506),
		start_time: new Date('2027-01-10T13:00:00Z'),
		end_time: new Date('2027-01-11T19:00:00Z'),
			...
			create: [
				{
					...
					price: 0,
					total_quantity: 1000,
					sale_start_time: new Date('2026-12-10'),
					sale_end_time: new Date('2027-01-11'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'台灣街舞推廣協會',
			'街舞大賽',
			'來自全國各地的頂尖舞者齊聚一堂，爭奪年度冠軍寶座，感受熱血沸騰的 Battle 現場，見證舞王的誕生',
		),
		cover_image:
			'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('比賽', 601),
		start_time: new Date('2026-12-27T13:00:00Z'),
		end_time: new Date('2026-12-27T21:00:00Z'),
			...
			create: [
				{
					...
					price: 300,
					total_quantity: 1000,
					sale_start_time: new Date('2026-11-27'),
					sale_end_time: new Date('2026-12-26'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'虛擬實境電競聯盟',
			'VR 電競賽',
			'穿戴最新 VR 設備，進行 4v4 戰術射擊對戰，體驗沉浸式的未來電子競技，挑戰你的反應極限',
		),
		cover_image:
			'https://images.unsplash.com/photo-1653158861306-e5b3804f6115?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
		images: generateEventImages('比賽', 602),
		start_time: new Date('2027-01-17T10:00:00Z'),
		end_time: new Date('2027-01-18T18:00:00Z'),
			...
			create: [
				{
					...
					total_quantity: 32,
					sale_start_time: new Date('2026-12-01'),
					sale_end_time: new Date('2027-01-10'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'子皿有限公司',
			'樂團演唱會',
			'台灣最具代表性的數字搖滾樂團，以精湛的技巧與夢幻的旋律，帶給樂迷最純粹的感動，沉浸在音符編織的夢境中',
		),
		cover_image:
			'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('表演', 701),
		start_time: new Date('2026-12-19T20:00:00Z'),
		end_time: new Date('2026-12-19T22:30:00Z'),
			...
			create: [
				{
					...
					total_quantity: 800,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2026-12-18'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'卡米地喜劇俱樂部',
			'漫才表演',
			'由新銳漫才組合輪番上陣，用快節奏的吐槽與裝傻，為您帶來整晚的歡笑，釋放生活壓力的最佳解方',
		),
		cover_image:
			'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('表演', 702),
		start_time: new Date('2026-11-28T20:00:00Z'),
		end_time: new Date('2026-11-28T22:00:00Z'),
			...
			create: [
				{
					...
					total_quantity: 150,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2026-11-27'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'台灣綠能產業協會',
			'綠色科技研討會',
			'邀請產官學界專家，探討再生能源發展、碳權交易與企業 ESG 轉型策略，掌握綠色經濟的未來趨勢',
		),
		cover_image:
		...
		start_time: new Date('2026-12-02T09:00:00Z'),
		end_time: new Date('2026-12-02T17:00:00Z'),
			...
			create: [
				{
					...
					total_quantity: 500,
					sale_start_time: new Date('2026-11-01'),
					sale_end_time: new Date('2026-12-01'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'數位醫療策進會',
			'AI 醫療研討會',
			'探討 AI 如何輔助診斷、加速新藥開發以及個性化醫療的未來發展，看見科技如何守護人類健康',
		),
		cover_image:
			'https://images.unsplash.com/photo-1569396116180-210c182bedb8?q=80&w=1738&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
		images: generateEventImages('研討會', 802),
		start_time: new Date('2027-01-15T14:00:00Z'),
		end_time: new Date('2027-01-15T17:00:00Z'),
			...
			create: [
				{
					...
					total_quantity: 200,
					sale_start_time: new Date('2026-12-01'),
					sale_end_time: new Date('2027-01-14'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'旅行癮者俱樂部',
			'旅遊分享會',
			'講者將分享他在南美洲流浪半年的所見所聞，包含馬丘比丘的壯麗與亞馬遜雨林的神秘，啟發你對世界的探索慾望',
		),
		cover_image:
			'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('分享會', 901),
		start_time: new Date('2026-12-07T19:00:00Z'),
		end_time: new Date('2026-12-07T21:00:00Z'),
		location_name: '旅行思維空間',
		address: '台北市大安區',
		latitude: new Prisma.Decimal(25.03),
		longitude: new Prisma.Decimal(121.55),
		status: EventStatus.APPROVED,
		event_type: EventType.OFFLINE,
		ticketTypes: {
			create: [
				{
					...
					price: 200,
					total_quantity: 50,
					sale_start_time: new Date('2026-11-07'),
					sale_end_time: new Date('2026-12-06'),
				},
			],
		},
	...
	},
	{
		...
		description: generateDescription(
			'創作者加速器',
			'自媒體分享會',
			'知名 YouTuber 現身說法，分享頻道定位、腳本企劃與社群經營的實戰經驗，幫助你打造具影響力的個人品牌',
		),
		cover_image:
			'https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('分享會', 902),
		start_time: new Date('2027-01-08T19:30:00Z'),
		end_time: new Date('2027-01-08T21:30:00Z'),
			...
			create: [
				{
					...
					total_quantity: 500,
					sale_start_time: new Date('2026-12-01'),
					sale_end_time: new Date('2027-01-07'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'文具文創小舖',
			'插畫家簽名會',
			'超人氣貼圖角色創作者舉辦年度簽名會，現場還有巨型公仔供粉絲合影留念，快來與你的偶像近距離接觸',
		),
		cover_image:
			'https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('見面會', 1001),
		start_time: new Date('2026-12-13T14:00:00Z'),
		end_time: new Date('2026-12-13T16:00:00Z'),
		location_name: '誠品生活南西店',
		address: '台北市中山區南京西路14號',
		latitude: new Prisma.Decimal(25.052),
		longitude: new Prisma.Decimal(121.52),
		status: EventStatus.APPROVED,
		event_type: EventType.OFFLINE,
		ticketTypes: {
			create: [
	...
	},
	{
		...
		description: generateDescription(
			'職棒球員工會',
			'球星見面會',
			'總冠軍 MVP 球員親臨現場，與球迷近距離互動遊戲，並分享奪冠心路歷程，是棒球迷絕對不能錯過的時刻',
		),
		cover_image:
		...
		start_time: new Date('2027-01-24T13:00:00Z'),
		end_time: new Date('2027-01-24T15:00:00Z'),
		location_name: '台北大巨蛋園區',
		address: '台北市信義區忠孝東路四段',
		latitude: new Prisma.Decimal(25.04),
			...
			create: [
				{
					...
					price: 500,
					total_quantity: 300,
					sale_start_time: new Date('2026-12-24'),
					sale_end_time: new Date('2027-01-23'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'台北市電腦公會',
			'電玩展記者會',
			'搶先曝光 2026 電玩展參展大作與亮點活動，媒體與玩家不可錯過的情報前哨戰，第一手掌握最新的遊戲資訊',
		),
		cover_image:
		...
		start_time: new Date('2027-01-10T14:00:00Z'),
		end_time: new Date('2027-01-10T15:30:00Z'),
			...
			create: [
				{
					...
					total_quantity: 200,
					sale_start_time: new Date('2026-12-10'),
					sale_end_time: new Date('2026-12-10'),
				},
			],
		}, // Fixed Sale time
	...
	},
	{
		...
		description: generateDescription(
			'星光影業',
			'電影首映會',
			'好萊塢巨星主演，導演與演員將出席紅毯儀式，邀請影迷搶先觀賞這部跨越時空的動人故事，見證史詩級的視覺饗宴',
		),
		cover_image:
			'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?auto=format&fit=crop&w=800&q=80',
		images: generateEventImages('宣傳', 1102),
		start_time: new Date('2026-12-20T18:00:00Z'),
		end_time: new Date('2026-12-20T21:00:00Z'),
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'島內散步',
			'夜間導覽',
			'在夜晚的微光中，走訪迪化街的老洋樓，聽導覽老師講述流傳百年的鄉野奇談與歷史軼事，感受老台北的神秘面紗',
		),
		cover_image:
	...
	},
	{
		...
		description: generateDescription(
			'歷史文物講堂',
			'博物館導覽',
			'專業講師深入淺出，帶您看懂毛公鼎、散氏盤上的銘文，了解三千年前的工藝與歷史，重現古代文明的輝煌',
		),
		cover_image:
			'https://images.unsplash.com/photo-1762529484143-9430545abda6?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
		images: generateEventImages('導覽', 1202),
		start_time: new Date('2027-01-11T10:00:00Z'),
		end_time: new Date('2027-01-11T12:00:00Z'),
			...
			create: [
				{
					...
					price: 400,
					total_quantity: 20,
					sale_start_time: new Date('2026-12-11'),
					sale_end_time: new Date('2027-01-10'),
				},
			],
		},
	...
	// ==========================================
	{
		...
		description: generateDescription(
			'三星農會推廣部',
			'農事體驗',
			'穿上雨鞋下田拔蔥，洗蔥，並親手揉麵團製作香酥的三星蔥油餅，適合全家大小的食農教育，體驗一日農夫的樂趣',
		),
		cover_image:
		...
		start_time: new Date('2026-12-06T10:00:00Z'),
		end_time: new Date('2026-12-06T14:00:00Z'),
		location_name: '蔥仔寮體驗農場',
		address: '宜蘭縣三星鄉東興路',
		latitude: new Prisma.Decimal(24.665),
		longitude: new Prisma.Decimal(121.65),
		status: EventStatus.APPROVED,
		event_type: EventType.OFFLINE,
		ticketTypes: {
			create: [
	...
	},
	{
		...
		description: generateDescription(
			'慢活金工工作室',
			'金工體驗',
			'在專業金工師傅指導下，從銀條敲打、退火、鋸切到拋光，親手打造一枚獨一無二的純銀戒指，送禮自用兩相宜',
		),
		cover_image:
			'https://images.unsplash.com/photo-1624588057318-5f1b2eb81012?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
		images: generateEventImages('體驗', 1302),
		start_time: new Date('2026-12-25T14:00:00Z'),
		end_time: new Date('2026-12-25T17:00:00Z'),
			...
			create: [
				{
					...
					price: 1800,
					total_quantity: 10,
					sale_start_time: new Date('2026-11-25'),
					sale_end_time: new Date('2026-12-24'),
				},
			],
		},
