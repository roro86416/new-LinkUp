...
import * as c from "./organizer-controller";
...
router.put("/events/:eventId/guests/:guestId", verify(updateGuestSchema), c.updateGuest);
router.delete("/events/:eventId/guests/:guestId", c.deleteGuest);

// Ticket Types
router.post("/events/:eventId/ticket-types", verify(createTicketTypeSchema), c.addTicketType);
router.put("/events/:eventId/ticket-types/:ticketTypeId", verify(updateTicketTypeSchema), c.updateTicketType);
router.delete("/events/:eventId/ticket-types/:ticketTypeId", c.deleteTicketType);

// Coupons
router.post("/events/:eventId/coupons", verify(createCouponSchema), c.addCoupon);
router.put("/events/:eventId/coupons/:couponId", verify(updateCouponSchema), c.updateCoupon);
router.delete("/events/:eventId/coupons/:couponId", c.deleteCoupon);

// Attachments
router.post("/events/:eventId/attachments", verify(createAttachmentSchema), c.addAttachment);
