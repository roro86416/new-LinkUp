    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-md">
      <div className="bg-white/30 backdrop-blur-md rounded-xl w-96 p-6 shadow-lg relative">
        ...
        <div className="text-center text-sm text-gray-900">
          還未註冊嗎？{" "}
          <span
            className="text-[#658AD0] hover:text-[#5a7ab8] cursor-pointer font-medium"
            onClick={onSwitch}
          >
            請註冊
          </span>
  ...
  const events = [
    {
      ...
      title: "創業者交流夜",
      date: "Oct 20, 2025",
      desc: "與創業者互相交流經驗，探討創業過程中的挑戰與機會，並建立人脈網絡。",
    ...
    },
    {
      ...
      title: "AI 科技論壇",
      date: "Oct 21, 2025",
      desc: "探索人工智慧最新趨勢，了解AI在各行各業的應用與發展方向。",
    ...
    },
    {
      ...
      title: "設計思維工作坊",
      date: "Oct 22, 2025",
      desc: "動手實作設計思維案例，學習如何以用戶為中心進行產品設計與創新。",
    ...
    },
    {
      ...
      title: "音樂創作夜",
      date: "Oct 23, 2025",
      desc: "與音樂人一起創作音樂，分享創作技巧並體驗音樂合作的樂趣。",
  ...
  return (
    <div className="relative min-h-screen text-gray-900 bg-white overflow-x-hidden">
      ...
      <section className="relative w-full h-[400px] overflow-hidden">
        ...
        >
          <span className="text-white text-3xl select-none drop-shadow-md">
            ‹
          </span>
        </div>
        <div
...
                  ${
                          selected
                            ? "bg-[#658AD0] text-white"
                            : active
                            ? "bg-[#658AD0]/50 text-white"
                            : "text-gray-900"
                        }`
                      }
                      value={loc}
