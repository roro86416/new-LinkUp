...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-[99] flex items-center justify-between px-10 py-3 shadow-sm transition-all duration-300 ${isWhiteStyle
    ...
    >
      ...
      <div className="flex gap-4 items-center">
        ...
        {loading ? (
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative" ref={menuRef}>
              ...
              <button
                ...
                className={`w-10 h-10 rounded-full overflow-hidden border-2 transition cursor-pointer flex items-center justify-center ${isWhiteStyle
              ...
              >
                {user.avatar ? (
                  ...
                  <div
                    className={`w-full h-full flex items-center justify-center text-xl font-bold ${isAdmin ? 'bg-red-900 text-white' : 'bg-gray-500 text-white'
                      }`}
                  >
          ...
          <button
            onClick={openLogin}
            className={`flex items-center gap-2 font-medium transition-colors px-5 py-2 rounded-full cursor-pointer ${isWhiteStyle
