...
export default async function ArticlePage({
	...
	const imageTree = `${process.env.NEXT_PUBLIC_API_BASE_URL}/uploads/file-1763833836659-814654143.jpg`; // 假設這張是聖誕樹的圖
	const imageDinner = `${process.env.NEXT_PUBLIC_API_BASE_URL}/uploads/file-1763833823011-433021134.jpg`;
    ...
    `,
		...
		eventLink: `${process.env.NEXT_PUBLIC_API_BASE_URL}/uploads/file-1763376404896-842942761.jpg`,
	};
