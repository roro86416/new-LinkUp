import FeaturedCardMarquee from "../post-component/card/FeaturedCardMarquee";
import GridCard from "../post-component/card/Gridcard";
import HorizontalCard from "../post-component/card/HorizontalCard";
import FeaturedCard from "../post-component/card/HorizontalCard";

export default function HomePage() {
  return (
    <div className="space-y-24">
      {/* Hero / Featured Section with Marquee */}
        ...
        items={[
          {
            ...
            category: "Community",
            title: "My Event Full Life",
            description: "Stories behind the scenes…",
            href: "/post/a",
          },
          {
            image: "/images/hero2.jpg",
            category: "Insights",
            title: "Building Events That Matter",
            description: "Creators crafting experiences.",
            href: "/post/b",
          },
          {
            image: "/images/hero3.jpg",
            category: "Culture",
            title: "The New Wave of Organizers",
            description: "Young creators redefining community.",
            href: "/post/c",
          },
        ]}
      />
      ...
      <section className="bg-gray-50 py-16 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex gap-6 animate-[scroll_50s_linear_infinite]">
            <GridCard
            ...
            <GridCard
              ...
              title="The Future of Event Tech"
              category="Tech"
              href="/post/trend4"
            />
          </div>
      ...
      {/* Community Highlight Section with Marquee */}
      <section className="bg-lime-200 py-20 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-extrabold mb-8">Community</h2>

          <div className="flex gap-6 animate-[scroll_45s_linear_infinite]">
            <FeaturedCard
            ...
            <GridCard
              ...
              title="Local Creators Making a Difference"
              category="People"
              href="/post/community3"
            />
          </div>
        </div>
      </section>
