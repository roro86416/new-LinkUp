...
import { useRouter } from "next/navigation"; // [新增] 引入 useRouter
import {
  Container,
  Paper,
  Stack,
...
export default function EventDetailPageClient({
  ...
  const handleRegister = () => {
    // 跳轉到購票頁面，並帶上 eventId
    router.push(`/checkout/select-ticket?eventId=${eventId}`);
  };
            ...
            <Stack align="center">
              <Paper radius="xl" p="md" withBorder>
                ...
                {event.organizer.avatar ? (
                  ...
                  <div style={{ width: 64, height: 64, background: '#eee', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
